...
## 데이터 모델
- `questions(id, subject, category, type_tag, stem unique, choices jsonb null, answer_idx null, answer_text null, explanation, source)` — 이론은 choices+answer_idx, 실무(분개·결산)는 answer_text
...
- 데이터: 3과목(전산회계1·2급, 전산세무2급) × 122~125회 = 301문항 적재.
